...
<body>
    ...
    <div style="width:1345px;height:460px;margin-top: -10px;margin-left: 10px;margin-right:10px"><!--background: blue;-->
                        ...
                        <ul class="nav navbar-nav">
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <li style="margin-left:20px"><a href="showSH.action" style="text-decoration:none">沪A</a></li>
                                        </div>
                                        <div class="col-sm-3>">
                                            <li ><a href="showSZ.action" style="text-decoration:none">深A</a></li>
                                        </div>
                                    </div>
                                </ul>
                            </li>
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu" style="width:250px">
	                                <form action="showPrice.action" name="submitPrice">
                            ...
                            <li class="dropdown">
                                <a href="#">涨幅</a>
                                <ul class="dropdown-menu" style="width:250px">
                                	<form action="showUp.action" name="submitUp">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu" style="width:230px;">
                                	<form action="showVolLow.action" name="submitVolLow">
                                    ...
                                    <form action="showVolUp.action" name="submitVolUp">
                            ...
                            <li class="dropdown">
                                <a href="#">成交额</a>
                                <ul class="dropdown-menu" style="width:230px;">
                                	<form action="showVPrcLow.action" name="submitVPrcLow">
	                                    <label style="margin-left: 10px">小于等于:</label>
                                    ...
                                    <form action="showVPrcUp.action" name="submitVPrcUp">
	                                    <label style="margin-left: 10px;margin-top:10px">大于等于:</label>
        ...
        <div style="width: 100%;height:85%;float: left; "><!--background: green-->
                ...
                <tbody id="table2">
                    <s:iterator value="stocks1" status="st" var="st1">
						<tr>
							...
							<td><button type="button" class="btn" onclick="myAddCookies(this)"><span class="glyphicon glyphicon-plus"></span></button></td>
						</tr>
					</s:iterator>
				</tbody>
			</table>
